...
-- DROP FUNCTION IF EXISTS public.troba_id_cistell(VARIADIC integer[], integer) CASCADE;
CREATE OR REPLACE FUNCTION public.troba_id_cistell (VARIADIC variable integer[], OUT resultat integer)
	RETURNS integer
	LANGUAGE plpgsql
	VOLATILE
	SECURITY INVOKER
...
$$;
-- ddl-end --
ALTER FUNCTION public.troba_id_cistell(VARIADIC integer[], integer) OWNER TO jordipsql;
-- ddl-end --
...
-- DROP FUNCTION IF EXISTS public.crea_cistell(VARIADIC integer[], integer) CASCADE;
CREATE OR REPLACE FUNCTION public.crea_cistell(VARIADIC variable integer[], OUT resultat integer)
 RETURNS integer
 LANGUAGE plpgsql
 STRICT COST 1
AS $$
...
$$;
-- ddl-end --
ALTER FUNCTION public.crea_cistell(VARIADIC integer[], integer) OWNER TO jordipsql;
-- ddl-end --


-- object: public.taulatiquets | type: FUNCTION --
-- DROP FUNCTION IF EXISTS public.taulatiquets(variable integer) CASCADE;
...
$function$;
-- ddl-end --
ALTER FUNCTION public.taulatiquets(variable integer) OWNER TO jordipsql;
-- ddl-end --
...
ALTER TABLE public.cistell_compra ADD CONSTRAINT fkey_quantitat_1 FOREIGN KEY (fkey_producte_1)
...
ALTER TABLE public.cistell_compra ADD CONSTRAINT fkey_quantitat_2 FOREIGN KEY (fkey_producte_2)
REFERENCES public.quantitat (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
...
ALTER TABLE public.cistell_compra ADD CONSTRAINT fkey_quantitat_3 FOREIGN KEY (fkey_producte_3)
REFERENCES public.quantitat (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
...
ALTER TABLE public.cistell_compra ADD CONSTRAINT fkey_quantitat_4 FOREIGN KEY (fkey_producte_4)
REFERENCES public.quantitat (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
...
ALTER TABLE public.cistell_compra ADD CONSTRAINT fkey_quantitat_5 FOREIGN KEY (fkey_producte_5)
REFERENCES public.quantitat (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
...
ALTER TABLE public.cistell_compra ADD CONSTRAINT fkey_quantitat_6 FOREIGN KEY (fkey_producte_6)
REFERENCES public.quantitat (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
...
ALTER TABLE public.cistell_compra ADD CONSTRAINT fkey_quantitat_7 FOREIGN KEY (fkey_producte_7)
REFERENCES public.quantitat (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
...
ALTER TABLE public.cistell_compra ADD CONSTRAINT fkey_quantitat_8 FOREIGN KEY (fkey_producte_8)
REFERENCES public.quantitat (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
...
ALTER TABLE public.cistell_compra ADD CONSTRAINT fkey_quantitat_9 FOREIGN KEY (fkey_producte_9)
REFERENCES public.quantitat (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
...
ALTER TABLE public.cistell_compra ADD CONSTRAINT fkey_quantitat_10 FOREIGN KEY (fkey_producte_10)
REFERENCES public.quantitat (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
...
ALTER TABLE public.cistell_compra ADD CONSTRAINT fkey_quantitat_11 FOREIGN KEY (fkey_producte_11)
REFERENCES public.quantitat (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
...
ALTER TABLE public.cistell_compra ADD CONSTRAINT fkey_quantitat_12 FOREIGN KEY (fkey_producte_12)
REFERENCES public.quantitat (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
...
ALTER TABLE public.cistell_compra ADD CONSTRAINT fkey_quantitat_13 FOREIGN KEY (fkey_producte_13)
REFERENCES public.quantitat (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
...
ALTER TABLE public.cistell_compra ADD CONSTRAINT fkey_quantitat_14 FOREIGN KEY (fkey_producte_14)
REFERENCES public.quantitat (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
...
ALTER TABLE public.cistell_compra ADD CONSTRAINT fkey_quantitat_15 FOREIGN KEY (fkey_producte_15)
REFERENCES public.quantitat (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
...
ALTER TABLE public.cistell_compra ADD CONSTRAINT fkey_quantitat_16 FOREIGN KEY (fkey_producte_16)
REFERENCES public.quantitat (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
...
ALTER TABLE public.cistell_compra ADD CONSTRAINT fkey_quantitat_17 FOREIGN KEY (fkey_producte_17)
REFERENCES public.quantitat (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
...
ALTER TABLE public.cistell_compra ADD CONSTRAINT fkey_quantitat_18 FOREIGN KEY (fkey_producte_18)
REFERENCES public.quantitat (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
...
ALTER TABLE public.cistell_compra ADD CONSTRAINT fkey_quantitat_19 FOREIGN KEY (fkey_producte_19)
REFERENCES public.quantitat (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
...
ALTER TABLE public.cistell_compra ADD CONSTRAINT fkey_quantitat_20 FOREIGN KEY (fkey_producte_20)
REFERENCES public.quantitat (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
...
ALTER TABLE public.cistell_compra ADD CONSTRAINT fkey_quantitat_21 FOREIGN KEY (fkey_producte_21)
REFERENCES public.quantitat (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
...
ALTER TABLE public.cistell_compra ADD CONSTRAINT fkey_quantitat_22 FOREIGN KEY (fkey_producte_22)
REFERENCES public.quantitat (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
...
ALTER TABLE public.cistell_compra ADD CONSTRAINT fkey_quantitat_23 FOREIGN KEY (fkey_producte_23)
REFERENCES public.quantitat (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
...
ALTER TABLE public.cistell_compra ADD CONSTRAINT fkey_quantitat_24 FOREIGN KEY (fkey_producte_24)
REFERENCES public.quantitat (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
...
ALTER TABLE public.cistell_compra ADD CONSTRAINT fkey_quantitat_25 FOREIGN KEY (fkey_producte_25)
REFERENCES public.quantitat (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --

-- object: fkey_producte | type: CONSTRAINT --
-- ALTER TABLE public.quantitat DROP CONSTRAINT IF EXISTS fkey_producte CASCADE;
ALTER TABLE public.quantitat ADD CONSTRAINT fkey_producte FOREIGN KEY (fkey_producte)
